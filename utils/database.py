...
def create_indexes():
    ...
    # Filter indexes
    db.variants.create_index([("chr",pymongo.ASCENDING),("samples.info.POS",pymongo.ASCENDING),("orientation",pymongo.ASCENDING)], sparse=True)
    db.variants.create_index([("chr2",pymongo.ASCENDING),("samples.info.END",pymongo.ASCENDING),("remoteOrientation",pymongo.ASCENDING)], sparse=True)
...
def resetdb():
    ...
    """
    #connection.drop_database('vcf_explorer_beta')
    create_indexes()
